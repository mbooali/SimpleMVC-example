...
<tr>
	<td style="background-image:url(../static/images/main_filler.gif);background-repeat:repeat-y" width="900px">
		...
		<br />
        	<?php echo ViewHelper::wellcomMessage()?>
		<br />
        <b>.::<a href="<?php ViewHelper::createLinkUrl('user' , ViewHelper::userValidation())?>"><?php echo ViewHelper::userValidation(); ?> </a>
		::.</b>
	<h5><a href="<?php ViewHelper::createLinkUrl('user','editProfile')?>">Editprofile</a></h5>
	<?php if ( ViewHelper::isAdmin()){?>
	<h5><a href="<?php echo ViewHelper::createLinkUrl('post','addPost');?>">Add Post </a></h5>
	<h5><a href="<?php echo ViewHelper::createLinkUrl('admin','editUserState');?>">Edit Users </a></h5>
	<?php }?>
        </div>
    </td>
</tr>
