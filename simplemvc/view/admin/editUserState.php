<?php require_once './utility/view_helper.php';ViewHelper::isAdmin1() ?>
	...
	<td style="background-image:url(../static/images/main_filler.gif);background-repeat:repeat-y" width="900px">
	    ...
	    <?php foreach ($users as $user) { ?>
	    	<tr>
		    	...
		    	<td>
		    		<a href="<?php ViewHelper::createLinkUrl('admin' , 'editUser')?>?userId=<?php echo $user->userId?>">Edit User</a>
		    	</td>
	    	</tr>
